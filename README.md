...
To clarify, here is a gif of the full range of behavior that your login screen should exhibit _(ignoring that this is running on localhost:8080, that the game page is a placeholder)_:
